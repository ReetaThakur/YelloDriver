...
public class KAlertDialog extends AlertDialog implements View.OnClickListener {
    ...
    TextView mUnderLineButton;

    private String mTitleText, mContentText, mCancelText, mConfirmText,mUnderLineText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUnderLineButton = findViewById(R.id.underline_button);
    ...
    public KAlertDialog setUnderLined(String text){
        mUnderLineText = text;
        if (mUnderLineButton != null && mUnderLineText != null) {
            showUnderLineButton(true);
            /*SpannableString content = new SpannableString(text);
            content.setSpan(new UnderlineSpan(), 0, text.length(), 0);
            mUnderLineButton.setText(content);*/

            String styledText = "<u>"+text+"</u>";
            mUnderLineButton.setText(Html.fromHtml(styledText), TextView.BufferType.SPANNABLE);
    ...
    public KAlertDialog showUnderLineButton (boolean isShow){
        mShowConfirm = isShow;
        if (mUnderLineButton != null) {
            mUnderLineButton.setVisibility(mShowConfirm ? View.VISIBLE : View.GONE);
        }
        return this;
    }
